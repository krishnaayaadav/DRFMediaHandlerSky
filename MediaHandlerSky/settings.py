"""
Django settings for MediaHandlerSky project.
...
SECRET_KEY = 'django-insecure-%2hr2f-=%qk2i6waq7+llf52n9j$c!gt-_859=8io%rvq=7a0k'
...
ROOT_URLCONF = 'MediaHandlerSky.urls'
...
WSGI_APPLICATION = 'MediaHandlerSky.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    # default schema class for api docs
